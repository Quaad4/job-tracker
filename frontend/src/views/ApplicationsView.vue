        ...
        <header class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto px-4 py-5 flex justify-between items-center">
                ...
                <div class="justify-between items-center gap-2 flex">
                    ...
                    <button v-if="authStore.isAuthenticated" @click="authStore.logout()" class="bg-blue-600 hover:bg-blue-709 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors cursor-pointer">Logout</button>
                </div>
            </div>
        </header>
